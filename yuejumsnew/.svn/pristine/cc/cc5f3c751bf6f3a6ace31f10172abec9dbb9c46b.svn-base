                        ...
                        <div class="panel-body">
                            <div class="adv-table editable-table ">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    <thead>
                                    <tr>
                                        <th><input type="checkbox" name="house"></th>
                                        <th>城市</th>
                                        <th>城区</th>
                                        <th>街道</th>
                                        <th>类型</th>
                                    ...
                                    <?php foreach ($house as $v){?>
                                        <tr class="tt">
                                            <td><input type="checkbox" value="<?php echo $v->house_id?>"></td>
                                            ...
                                            <td><a class="delete" href="javascript:;" houseid="<?php echo $v->house_id?>">Delete</a></td>
                                        </tr>
                                    <?php }?>
                                    </tbody>
                                </table>
